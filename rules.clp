...
; Rule 13: Office Usage, Budget Type 5, Merek Non Apple (above 15jt)
(defrule usage-office-budget5-nonapple "Digunakan untuk menentukan penggunaan laptop casual/office"
   (attribute (usage "office"))
   (attribute (budget ?budget))
   (test (>= ?budget 15000000))
   (attribute (brand "non-apple"))
...
; Rule 22: Office Usage, Budget Type 5, Merek Apple (above 15jt)
(defrule usage-design-budget5-apple "Digunakan untuk menentukan penggunaan laptop casual/office"
   (attribute (usage "office"))
   (attribute (budget ?budget))
   (test (>= ?budget 15000000))
   (attribute (brand "apple"))
   ...
   (printout t "Berdasarkan pemilihan Laptop Office yang memiliki budget di atas 15 juta dengan merk Apple, Laptop yang cocok adalah macbook-pro-mluq2")
)
